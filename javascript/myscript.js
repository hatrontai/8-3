...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= " " + (thePercent-1) + "%";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-body').innerHTML = 'U know ? I and other boys think that we are so lucky because you all are so cute<i class="fas fa-heart"></i> ';
